        ...
        <>
            <div className="space-y-6 animate-fade-in">
                <div className="flex items-center justify-between">
                    ...
                    {stores.length === 0 ? (
                        <button
                            onClick={() => alert("Iltimos, avval 'Filiallar' bo'limidan yangi do'kon (filial) yarating. Kassir faqat filialga biriktiriladi.")}
                            className="flex items-center gap-2 rounded-lg bg-white/50 px-4 py-2 text-sm font-semibold text-black transition-all cursor-not-allowed"
                        >
